...
### v1.7.7:
	...
	- Fix money prop not going in strippers hands when paid
	- Fixed duplicate jobCheck() event, and fixed the locale error for it
	- Fix coffee maker not being usable, this was due to a removed event. Sorry.
...
### v1.7.6:
	...
	- Add/Fix Multicraft events
	- Improve urinal animation and functions
	- Tided up a few progressbar functions
	- Added Config option toggle for ingame native music playing (DisableMusic)
	 - To turn audio back on, disable this and restart game
	- Added clock in locations to cash registers for convenience
