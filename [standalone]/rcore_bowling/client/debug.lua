...
--     while true do
--         Wait(0)
--         local lane = Lanes.K4MB1_1
--         if lane.StartPos then
--             RenderDebugOiling(Lanes.K4MB1_1)
--             RenderDebugOiling(Lanes.K4MB1_2)
--             RenderDebugOiling(Lanes.K4MB1_3)
--             RenderDebugOiling(Lanes.K4MB1_4)
--             RenderDebugOiling(Lanes.K4MB1_5)
--             RenderDebugOiling(Lanes.K4MB1_6)
--         end
--     end
-- end)
