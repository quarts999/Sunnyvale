...
-- 1 = QBCore Inventory (ps-inventory)
...
Config.TargetOptions = {
    enableDrugs = false, -- Enables the support for targeting scripts for drug selling
    enableActions = false, -- Enables the support for targeting scripts for actions (robbing/kidnapping)
}
