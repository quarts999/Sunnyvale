...
if string.lower(Targetting) == "ox" or string.lower(Targetting) == "ox_target" or string.lower(Targetting) == "ox-target" then
...
if string.lower(Targetting) == "qb"  or string.lower(Targetting) == "qb_target" or string.lower(Targetting) == "qb-target" then
	-- affError("Targetting set on QB-Target")
	function targetBoxZone(option)
