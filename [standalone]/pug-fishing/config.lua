Config.BagProp = "prop_med_bag_01" -- The bag prop that is used in the catching of a fish animation (some servers change this prop to a wheelchair for some reason....)
----------
...
----------
-- Add blacklisted fishing locations here if you like. (20.0 radius)
