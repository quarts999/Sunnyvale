...
Lang["br"] = {
	...
	statistics_page_money_earned: "Dinheiro ganho",
	...
	diagnostic_page_refuel_label: "Reabastecer",
	...
	drivers_page_driver_fuel: "Combustível",
	drivers_page_fire_button: "Demitir motorista",
	drivers_page_refuel_button: "Abastecer caminhão {0}",
	...
	party_page_create: "Criar grupo",
	party_page_join: "Entrar no grupo",
	party_page_name: "Nome do Grupo*",
	party_page_subtitle: "Descrição do Grupo*",
	party_page_password: "Senha",
	party_page_password_confirm: "Confirmar Senha",
	party_page_members: "Quantidade de Membros*",
	party_page_finish_button: "Concluir ({0} + {1})",
	party_page_finish_button_2: "Concluir",
	party_page_password_mismatch: "* Senha incorreta",
	party_leader: "Lider do grupo",
	party_finished_deliveries: "Entregas finalizadas com o grupo: {0}",
	party_joined_time: "No grupo desde: {0}",
	party_kick: "Expulsar do grupo",
	party_quit: "Sair do grupo",
	party_delete: "Excluir grupo",

	bank_page_title: "Banco",
	bank_page_desc: "Veja aqui as informações da sua conta bancária da sua companhia",
	bank_page_withdraw: "Sacar dinheiro",
	bank_page_deposit: "Depositar dinheiro",
	bank_page_balance: "O seu saldo é:",
	bank_page_active_loans: "Empréstimos ativos",

	bank_page_loan_title: "Empréstimos",
	bank_page_loan_desc: "Faça empréstimos para investir na sua empresa!<BR>(Empréstimo máximo: {0})",
	bank_page_loan_button: "Fazer empréstimo",
	bank_page_loan_value_title: "Valor do empréstimo",
	bank_page_loan_daily_title: "Pagamento diário",
	bank_page_loan_remaining_title: "Valor restante",
	bank_page_loan_date_title: "Pagamento (Auto-Debit)",
	bank_page_loan_pay: "Quitar empréstimo",

	bank_page_loan_modal_desc: "Selecione um dos tipos de empréstimo:",
	bank_page_loan_modal_item: "({0}% de taxa de juros, quitável em {1} dias)",
	bank_page_loan_modal_submit: "Fazer empréstimo",

	bank_page_deposit_modal_title: "Depositar dinheiro",
	bank_page_deposit_modal_desc: "Quanto você deseja depositar?",
	bank_page_deposit_modal_submit: "Depositar dinheiro",

	bank_page_withdraw_modal_title: "Sacar dinheiro",
	bank_page_withdraw_modal_desc: "Quanto você deseja sacar?",
	bank_page_withdraw_modal_submit: "Sacar dinheiro",

	bank_page_modal_placeholder: "Insira o valor",
	bank_page_modal_money_available: "Dinheiro disponível: {0}",
