return {
    ...
    BasketBallHoops = {
        {
            pos = vector3(1719.612304, 2549.735840, 42.577492), 
            rot = vector4(0.000000, 0.000000, 0.236716, 0.971578),
            State = nil,
        ...
        {
            pos = vector3(1731.795532, 2526.293212, 42.577564), 
            rot = vector4(-0.000000, 0.000000, 0.972842, -0.231466),
            State = nil,
            Model = `prop_basketball_net`,
            IsSubscribed = false,
            threePointFwdDist = 0.0,
        ...
        {
            pos = vector3(1689.109986, 2523.141114, 44.556892), 
            rot = vector4(0.000000, 0.000000, -0.340030, 0.940414),
            State = nil,
            Model = `prop_basketball_net`,
            IsSubscribed = false,
            threePointFwdDist = 0.0,
        ...
        {
            pos = vector3(1671.621948, 2502.817872, 44.556962), 
            rot = vector4(0.000000, 0.000000, 0.937966, 0.346728),
            State = nil,
            Model = `prop_basketball_net`,
            IsSubscribed = false,
            threePointFwdDist = 0.0,
    ...
    [STRUCT_GUARDS] = {
        {
            ...
            [STRUCT_MODEL] = GetHashKey('s_m_m_prisguard_01'),
    ...
    jobs = {
        ...
        },
        {
            ...
            points = {
                {pos = vec4(1780.927, 2564.290, 45.673, 4.302)},
            }
        },
        {
    ...
    interaction = {
        ...
        {
            coords = vec3(1783.22, 2560.78, 45.67),
        ...
        {
            coords = vec3(1769.14, 2565.84, 45.57),
...

        {
            ...
            coords = vec3(1751.16, 2541.03, 43.98 - 1),
            exercise = EXERCISE_MAP.SITUPS,
            type = INTERACT_TYPES.GYM,
            access = INTERACT_ACCESS_TYPES.ALL
        },

        {
            ...
            coords = vec3(1749.38, 2545.0, 43.98 - 1),
            exercise = EXERCISE_MAP.SITUPS,
            type = INTERACT_TYPES.GYM,
            access = INTERACT_ACCESS_TYPES.ALL
        },

        {
            ...
            coords = vec3(1742.6, 2541.4, 43.98 - 1),
            exercise = EXERCISE_MAP.SITUPS,
            type = INTERACT_TYPES.GYM,
            access = INTERACT_ACCESS_TYPES.ALL
        },

        {
            ...
            coords = vec3(1744.58, 2537.47, 43.98 - 1),
            exercise = EXERCISE_MAP.SITUPS,
            type = INTERACT_TYPES.GYM,
            access = INTERACT_ACCESS_TYPES.ALL
        },
