...
CreateThread(function()        
    if isBridgeLoaded('Inventory', Inventories.QB) then
        ...
        AssetDeployer:registerCopyFilesDeploy('items-images', Inventories.QB, 'assets/inventoryImages/png', 'html/images',
            function(data)
                local files = {}
                ...
                return files
            end, { 'sprunk', 'sludgie', 'ecola_light', 'ecola', 'coffee', 'water', 'fries', 'pizza_ham', 'chips', 'donut', 'wire_cutter', 'cigarrete' }
        )
