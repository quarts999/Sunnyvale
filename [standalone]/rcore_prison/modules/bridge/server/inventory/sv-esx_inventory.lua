...
CreateThread(function()
    if (isBridgeLoaded('Framework', Framework.ESX)) and not isResourceLoaded('inventory') then
        if resourceList['Inventory'] and resourceList['Inventory'] ~= Inventories.ESX then
