...
Config.Locations = {
    duty = {
        vector3(442.71, -981.92, 30.69),
    },
    vehicle = {
        vector4(431.23, -986.03, 25.7, 175.93),
        -- vector4(471.13, -1024.05, 28.17, 274.5),
        -- vector4(-455.39, 6002.02, 31.34, 87.93),
    },
    stash = {
        vector3(461.92, -999.7, 30.69),
        vector3(462.5, -995.84, 30.69)
    },
    impound = {
    ...
    trash = {
        vector3(472.35, -1002.17, 30.69),
    },
    fingerprint = {
        vector3(473.14, -1007.45, 26.27),
    },
    evidence = {
        vector3(475.09, -996.61, 26.27),
        vector3(472.6, -996.61, 26.27),
    },
    stations = {
