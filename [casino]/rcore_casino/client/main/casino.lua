...
CreateThread(function()
    ...
    while true do
        ...
        if GAME_TIMER - LastCasinoUpdate > 500 then
            ...
            local c = IsEntityInArea(PlayerPedId(), CASINO_AREA_MIN, CASINO_AREA_MAX, true, true) -- casino area inside
...
RegisterNetEvent("Casino:VehicleGiven")
AddEventHandler("Casino:VehicleGiven", function(properties)
    -- prepared some keys
